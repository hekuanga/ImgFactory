    ...
    <div className='flex max-w-7xl mx-auto flex-col items-center justify-center min-h-screen bg-[#F7F4E9] dark:bg-slate-900 transition-colors duration-300'>
      ...
      <main className='flex flex-1 w-full flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-6 sm:py-8'>
        ...
        <div className='text-center mb-6 sm:mb-8 lg:mb-10 w-full'>
          <h1 className='mx-auto max-w-4xl font-display text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-normal text-slate-900 dark:text-slate-100 mb-2 transition-colors duration-300'>
            {t.home.title}
          </h1>
          <p className='mx-auto text-sm sm:text-base lg:text-lg text-slate-600 dark:text-slate-400 transition-colors duration-300'>
            {t.home.subtitle}
          </p>
        </div>
